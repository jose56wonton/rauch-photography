...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gatsbyImage = __webpack_require__(82);
	...
	var WorkCategoryLayout = function (_Component) {
	  _inherits(WorkCategoryLayout, _Component);
	
	  function WorkCategoryLayout(props) {
	    _classCallCheck(this, WorkCategoryLayout);
	
	    var _this = _possibleConstructorReturn(this, _Component.call(this, props));
	
	    _this.link = function () {
	      (0, _gatsbyLink.navigateTo)("/" + _this.props.path);
	    };
	
	    _this.hoverOffText = function () {
	      _this.setState({ textHover: false });
	    };
	
	    _this.hoverOnText = function () {
	      _this.setState({ textHover: true });
	    };
	    ...
	    _this.getClassesFromProps = function () {
	      var _this$props = _this.props,
	          leftOrientation = _this$props.leftOrientation,
	          centerOrientation = _this$props.centerOrientation,
	          rightOrientation = _this$props.rightOrientation,
	    ...
	    _this.initializeScene = function () {
	      var scene = new ScrollMagic.Scene({
	        triggerElement: "#work-category-" + _this.props.index,
	        triggerHook: ".5"
	      }).duration(1000).on("progress", function (event) {
	        _this.setState({
	        ...
	        if (_this.props.version) {
	          _this.setState({
	            cssForLeftImage: {
	              transform: "translate(" + Math.floor(event.progress * 50) + "px, " + Math.floor(event.progress * 25) + "px)"
	            },
	            cssForRightImage: {
	              transform: "translate(" + -Math.floor(event.progress * 50) + "px, " + -Math.floor(event.progress * 25) + "px)"
	            }
	  ...
	  WorkCategoryLayout.prototype.componentDidMount = function componentDidMount() {
	    this.setState({
	      controller: new ScrollMagic.Controller(),
	  ...
	  WorkCategoryLayout.prototype.render = function render() {
	    console.log(this.props);
	
	    return _react2.default.createElement(
	      "div",
	      { className: "work-category", id: "work-category-" + this.props.index },
	      _react2.default.createElement(
	        "div",
	        { className: "work-category-pictures columns is-gapless " },
	        _react2.default.createElement(
	          "div",
	          {
	            className: "column  " + this.state.classes[0],
	            key: this.state.progress * 40,
	      ...
	      _react2.default.createElement(
	        "div",
	        { className: "work-category-content", onClick: this.link },
	        _react2.default.createElement(
	          "h3",
	          {
	  ...
	  return WorkCategoryLayout;
	}(_react.Component);
	
	exports.default = WorkCategoryLayout;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _workCategoryLayout = __webpack_require__(300);
	
	var _workCategoryLayout2 = _interopRequireDefault(_workCategoryLayout);
	
	var _gatsbyLink = __webpack_require__(23);
	
	var _gatsbyLink2 = _interopRequireDefault(_gatsbyLink);
	
	var _blank = __webpack_require__(102);
	...
	exports.default = function (_ref) {
	  ...
	  if (data.allMarkdownRemark) {
	    content = data.allMarkdownRemark.edges.map(function (_ref2, i) {
	      var node = _ref2.node;
	      ...
	      return _react2.default.createElement(
	        "div",
	        { key: i * 10 },
	        _react2.default.createElement(_workCategoryLayout2.default, {
	    ...
	    content = _react2.default.createElement(_blank2.default, null);
	  }
	  return _react2.default.createElement(
	    "div",
	    { className: "container" },
...
//# sourceMappingURL=component---src-templates-work-category-js-169e9568783676eceabd.js.map