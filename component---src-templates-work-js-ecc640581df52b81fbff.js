...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WorkLayout = function (_Component) {
	  ...
	  function WorkLayout(props) {
	    ...
	    _this.initializeScene = function () {
	      ...
	      var scene = new ScrollMagic.Scene({
	        triggerElement: "#work-" + _this.props.index,
	        triggerHook: ".5"
	  ...
	  WorkLayout.prototype.componentDidMount = function componentDidMount() {
	    this.setState({
	      controller: new ScrollMagic.Controller()
	    });
	  ...
	  WorkLayout.prototype.render = function render() {
	    return _react2.default.createElement(
	      "div",
	      { className: "work", id: "work-" + this.props.index },
	      _react2.default.createElement(
	        "div",
	        { className: "work-pictures version-" + this.props.version },
	        _react2.default.createElement(
	          "div",
	          { className: "col-1" },
	          _react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _workLayout = __webpack_require__(301);
	
	var _workLayout2 = _interopRequireDefault(_workLayout);
	...
	var Work = function (_Component) {
	  ...
	  Work.prototype.render = function render() {
	    ...
	    if (this.props.data.allMarkdownRemark) {
	      content = this.props.data.allMarkdownRemark.edges.map(function (_ref, i) {
	        var node = _ref.node;
	        ...
	        return _react2.default.createElement(
	          "div",
	          { key: i * 11 },
	          _react2.default.createElement(_workLayout2.default, {
...
//# sourceMappingURL=component---src-templates-work-js-ecc640581df52b81fbff.js.map